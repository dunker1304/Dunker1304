...
$.ajax({
    ...
    success: function(data){
        ...
        $('#questCont').text(data.question.content);
        $('.answer').attr("data-id", data.question._id);
        numOfYes = data.question.yes;
        numOfNo = data.question.no;
    },
    error: function(){
        console.log("Fail");
    }
...
$('.answer').on('click', function(event){
    ...
    console.log(answer, questionID, numOfYes, numOfNo);
...
$('.resultAnalyse').click(function(){
    ...
    $('.vote').text(+numOfYes + +numOfNo +' vote(s)')
